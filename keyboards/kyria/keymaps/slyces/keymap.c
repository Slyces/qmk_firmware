...
/*
 * Base Layer: Gaming (isaac & similar)
 * ,--------. ,----------------------------------.    ,----------------------------------. ,--------.
 ...
 *                                 | BASE |      |    |      | BASE |
 *            ,--------------------+------+------|    |------+------+--------------------.
 *            |      |      |  ALT | SPACE| CTRL |    | CTRL | ENTER|  ALT |      |      |
 *            |      |      |      |      |      |    |      |      |      |      |      |
 *            `----------------------------------'    `----------------------------------'
 */
    [_GAMING] = LAYOUT_kyria_custom_wrapper(
      KC_ESC ,      KC_1,  KC_2,  KC_3,  KC_4,  KC_5,  KC_6, KC_7, KC_8, KC_9, KC_0,            _______,
      KC_TAB ,      KC_A,  KC_S,  KC_W,  KC_D,  KC_Q,  KC_E, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______,
      _______, ________________BLANK________________,  ________________BLANK________________,   _______,
                               DF(_COLEMAK), _______,  _______, DF(_COLEMAK),
        _______, _______, KC_LALT, KC_SPACE, KC_LCTL,  KC_RCTL, KC_ENTER, KC_RALT, _______, _______
    ),
